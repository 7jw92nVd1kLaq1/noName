...
export const validateCategory = (category: number | undefined): string | null => {
  if (category == null) {
...
export const validateSpots = (spots: ISelectionSpot[] | undefined): string | null => {
  if (!spots) {
...
export const validateHashtags = (hashtags: string[] | undefined): string | null => {
  if (!hashtags) {
...
export const validateData = (data: ISelectionCreateFormData): string | null => {
